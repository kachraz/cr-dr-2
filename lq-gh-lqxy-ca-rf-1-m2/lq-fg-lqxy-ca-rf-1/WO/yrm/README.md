...
1. `RC` - Ref counter in rust 
   1. When you need multiple parts of your program to share ownership of a single value.
   2. When you want to ensure memory is automatically cleaned up when no longer needed.
   3. In tree-like or graph-like data structures where nodes may have multiple parents.
